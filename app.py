...
# =========================
# CSS (card dos filtros + tabela responsiva)
# =========================
st.markdown("""
<style>
...
# Marcador para o CSS encontrar o próximo bloco (vira o "card")
st.markdown('<div class="filter-card-start"></div>', unsafe_allow_html=True)
